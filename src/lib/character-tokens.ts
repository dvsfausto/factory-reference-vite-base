...
const BOLD: CharacterTokens = {
  ...
  cardElevation: 'transition-all hover:translate-y-(--hov-lift) hover:border-fam-accent hover:shadow-(--elev-4)',
...
const ELEGANT_LIGHT: CharacterTokens = {
  ...
  cardElevation: 'transition-all hover:translate-y-(--hov-lift) hover:border-fam-accent',
  buttonRadius: 'rounded-lg',
  headingCase: '',
...
const FRIENDLY: CharacterTokens = {
  ...
  cardElevation: 'shadow-(--elev-1) transition-all hover:translate-y-(--hov-lift) hover:shadow-(--elev-4)',
...
const CORPORATE: CharacterTokens = {
  ...
  muted: 'text-fam-ink-muted',
  cardRadius: 'rounded-lg',
  cardElevation: 'transition-all hover:translate-y-(--hov-lift) hover:shadow-(--elev-2)',
...
const CREATIVE: CharacterTokens = {
  ...
  muted: 'text-fam-ink-muted',
  cardRadius: 'rounded-2xl',
  cardElevation: 'transition-transform hover:translate-y-(--hov-lift-lg)',
  buttonRadius: 'rounded-2xl',
  headingCase: '',
  spacingY: 'py-16 md:py-24',
