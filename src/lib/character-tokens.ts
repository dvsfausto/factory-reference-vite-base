...
const BOLD: CharacterTokens = {
  ...
  cardElevation: 'transition-all hover:translate-y-(--hov-lift) hover:border-fam-accent hover:elev-4',
...
const FRIENDLY: CharacterTokens = {
  ...
  cardElevation: 'elev-1 transition-all hover:translate-y-(--hov-lift) hover:elev-4',
...
const CORPORATE: CharacterTokens = {
  ...
  muted: 'text-fam-ink-muted',
  cardRadius: 'rounded-lg',
  cardElevation: 'transition-all hover:translate-y-(--hov-lift) hover:elev-2',
