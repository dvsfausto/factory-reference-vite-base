...
const HEADER_THEMES: Record<string, HeaderTheme> = {
  ...
  bold: {
    ...
    skip: "focus:bg-fam-accent focus:text-white",
    ...
    areaAllLink: "text-fam-accent-text hover:bg-white/5",
  ...
  "elegant-light": {
    ...
    dropdownSurface: "bg-white border border-fam-hairline rounded-lg shadow-xl",
    dropdownItem: "hover:bg-fam-accent-soft",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text hover:bg-fam-accent-soft",
  ...
  modern: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-white border border-fam-hairline rounded-xl shadow-lg",
  ...
  corporate: {
    ...
    skip: "focus:bg-fam-accent focus:text-white",
    navLink: "font-display text-[15px] font-medium text-fam-ink hover:text-fam-accent-text",
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-white border border-fam-hairline rounded-md shadow-lg",
    dropdownItem: "hover:bg-fam-surface-2",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text hover:bg-fam-surface-2",
    phoneLink: "text-fam-ink hover:text-fam-accent-text",
    menuIcon: "text-fam-ink",
    logoLight: false,
    mobilePanel: "bg-white",
    mobileText: "text-fam-ink",
  ...
  creative: {
    ...
    skip: "focus:bg-fam-accent focus:text-white",
    navLink: "font-display text-[15px] font-bold text-fam-ink hover:text-fam-accent-text",
    ...
    dropdownSurface: "bg-white border border-fam-hairline rounded-2xl shadow-xl",
    dropdownItem: "hover:bg-fam-surface-2",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text hover:bg-fam-surface-2",
  ...
  clean: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-white border border-fam-hairline rounded-lg shadow-lg",
    dropdownItem: "hover:bg-[#F1F5F9]",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text hover:bg-[#F1F5F9]",
    phoneLink: "text-fam-ink-muted hover:text-fam-ink",
    menuIcon: "text-fam-ink",
    logoLight: false,
    mobilePanel: "bg-fam-surface",
  ...
  friendly: {
    ...
    skip: "focus:bg-fam-accent focus:text-white",
    navLink: "font-display text-[15px] font-medium text-fam-ink-muted hover:text-fam-accent-text",
    ...
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text hover:bg-fam-accent-soft",
    phoneLink: "text-fam-ink-muted hover:text-fam-accent-text",
    menuIcon: "text-fam-ink",
    logoLight: false,
    mobilePanel: "bg-fam-surface",
    mobileText: "text-fam-ink",
