...
const HEADER_THEMES: Record<string, HeaderTheme> = {
  ...
  bold: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-md bg-cta px-5 font-display text-sm font-semibold uppercase tracking-wide text-cta-foreground transition-opacity hover:opacity-(--hov-fade)",
    ctaLabel: "Free Quote",
  ...
  elegant: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-lg bg-cta px-5 font-display text-sm font-medium tracking-wide text-cta-foreground transition-opacity hover:opacity-(--hov-fade)",
    ctaLabel: "Free Quote",
  ...
  modern: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-xl bg-cta px-5 font-display text-sm font-semibold text-cta-foreground transition-opacity hover:opacity-(--hov-fade)",
    ctaLabel: "Free Quote",
  ...
  corporate: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-md bg-cta px-5 font-display text-sm font-semibold text-cta-foreground transition-opacity hover:opacity-(--hov-fade)",
    ctaLabel: "Free Quote",
  ...
  clean: {
    ...
    skip: "focus:bg-fam-accent focus:text-fam-on-accent",
    navLink: "font-display text-[15px] font-medium text-fam-ink-muted hover:text-fam-ink",
    cta: "inline-flex h-[42px] items-center rounded-lg bg-cta px-5 font-display text-sm font-semibold text-cta-foreground transition-opacity hover:opacity-(--hov-fade)",
    ctaLabel: "Free Quote",
  ...
  friendly: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-2xl bg-cta px-5 font-display text-sm font-semibold text-cta-foreground shadow-(--elev-2) transition-opacity hover:opacity-(--hov-fade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-2xl shadow-(--elev-4)",
    dropdownItem: "hover:bg-fam-accent-soft",
    dropdownTitle: "text-fam-ink",
