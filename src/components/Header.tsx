...
const HEADER_THEMES: Record<string, HeaderTheme> = {
  ...
  default: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-line-ink rounded-2xl elev-4",
    dropdownItem: "hover:bg-brand-50",
    dropdownTitle: "text-ink-900",
    dropdownSub: "text-ink-500",
    areaAllLink: "text-brand-600 hover:bg-brand-50",
  ...
  bold: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-panel-ink border border-fam-card/10 rounded-md elev-4",
  ...
  elegant: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-statement-2 border border-fam-statement-hairline rounded-lg elev-4",
  ...
  "elegant-light": {
    ...
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-lg elev-4",
  ...
  modern: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-xl elev-3",
  ...
  corporate: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-md elev-3",
    dropdownItem: "hover:bg-fam-surface-2",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
  ...
  creative: {
    ...
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-2xl elev-4",
    dropdownItem: "hover:bg-fam-surface-2",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text-strong hover:bg-fam-surface-2",
  ...
  clean: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-lg elev-3",
  ...
  friendly: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-2xl bg-cta px-5 font-display text-sm font-semibold text-cta-foreground elev-2 transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-2xl elev-4",
    dropdownItem: "hover:bg-fam-accent-soft",
    dropdownTitle: "text-fam-ink",
    ...
    mobileBorder: "border-fam-hairline",
    mobilePhone: "text-fam-accent-text-strong",
    mobileCta: "inline-flex h-12 w-full items-center justify-center rounded-2xl bg-cta font-display text-sm font-semibold text-cta-foreground elev-2",
  },
};
