...
const HEADER_THEMES: Record<string, HeaderTheme> = {
  ...
  wow: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-full px-5 text-sm font-semibold text-fam-on-dark bg-[image:var(--wow-grad-brand)] shadow-[var(--wow-shadow-glow)] transition-transform hover:translate-y-(--hov-lift-sm)",
    ctaLabel: "Free Quote",
  ...
  default: {
    ...
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-line-ink rounded-2xl shadow-(--elev-4)",
    dropdownItem: "hover:bg-brand-50",
    dropdownTitle: "text-ink-900",
    dropdownSub: "text-ink-500",
    areaAllLink: "text-brand-600 hover:bg-brand-50",
    ...
    mobileText: "text-ink-900",
    mobileLabel: "text-ink-500",
    mobileBorder: "border-fam-line-ink",
    mobilePhone: "text-brand-600",
  ...
  bold: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-md bg-cta px-5 font-display text-sm font-semibold uppercase tracking-wide text-cta-foreground transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-panel-ink border border-fam-card/10 rounded-md shadow-(--elev-4)",
  ...
  elegant: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-lg bg-cta px-5 font-display text-sm font-medium tracking-wide text-cta-foreground transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-statement-2 border border-fam-statement-hairline rounded-lg shadow-(--elev-4)",
  ...
  "elegant-light": {
    ...
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-lg shadow-(--elev-4)",
  ...
  modern: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-xl bg-cta px-5 font-display text-sm font-semibold text-cta-foreground transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-xl shadow-(--elev-3)",
  ...
  corporate: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-md bg-cta px-5 font-display text-sm font-semibold text-cta-foreground transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-md shadow-(--elev-3)",
    dropdownItem: "hover:bg-fam-surface-2",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
  ...
  creative: {
    ...
    cta: "inline-flex h-[44px] items-center rounded-2xl bg-cta px-5 font-display text-sm font-bold text-cta-foreground transition-transform hover:translate-y-(--hov-lift-sm)",
    ctaLabel: "Start a project",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-2xl shadow-(--elev-4)",
    dropdownItem: "hover:bg-fam-surface-2",
    dropdownTitle: "text-fam-ink",
    dropdownSub: "text-fam-ink-muted",
    areaAllLink: "text-fam-accent-text-strong hover:bg-fam-surface-2",
  ...
  clean: {
    ...
    skip: "focus:bg-fam-accent focus:text-fam-on-accent",
    navLink: "font-display text-[15px] font-medium text-fam-ink-muted hover:text-fam-ink",
    cta: "inline-flex h-[42px] items-center rounded-lg bg-cta px-5 font-display text-sm font-semibold text-cta-foreground transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-lg shadow-(--elev-3)",
  ...
  friendly: {
    ...
    cta: "inline-flex h-[42px] items-center rounded-2xl bg-cta px-5 font-display text-sm font-semibold text-cta-foreground shadow-(--elev-2) transition-[filter] hover:brightness-(--hov-shade)",
    ctaLabel: "Free Quote",
    dropdownSurface: "bg-fam-card border border-fam-hairline rounded-2xl shadow-(--elev-4)",
    dropdownItem: "hover:bg-fam-accent-soft",
    dropdownTitle: "text-fam-ink",
    ...
    mobileBorder: "border-fam-hairline",
    mobilePhone: "text-fam-accent-text-strong",
    mobileCta: "inline-flex h-12 w-full items-center justify-center rounded-2xl bg-cta font-display text-sm font-semibold text-cta-foreground shadow-(--elev-2)",
  },
};
