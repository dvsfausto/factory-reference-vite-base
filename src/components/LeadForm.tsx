...
export function LeadForm({
  ...
  return (
    <form
      onSubmit={onSubmit}
      noValidate
      className="rounded-2xl bg-fam-card p-6 elev-1 sm:p-8"
    >
      ...
      <button
        ...
        className="mt-6 inline-flex w-full items-center justify-center rounded-md bg-fam-accent px-6 py-3 font-semibold text-fam-on-accent elev-1 transition-colors hover:bg-fam-accent-deep disabled:opacity-60"
      >
