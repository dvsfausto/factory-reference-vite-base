...
const FOOTER_THEMES: Record<string, FooterTheme> = {
  wow: { surface: "bg-brand-900 text-fam-on-dark", tagline: "text-fam-on-dark/65", socialBorder: "border-fam-card/20", socialHover: "hover:bg-fam-card/10", heading: "text-fam-on-dark font-display tracking-wide", listText: "text-fam-on-dark/65", listHover: "hover:text-fam-on-dark", areaAll: "text-brand-200 hover:text-fam-on-dark", border: "border-fam-card/10", bottomText: "text-fam-on-dark/45", bottomHover: "hover:text-fam-on-dark", logoLight: true },
  default: { surface: "bg-brand-900 text-fam-on-dark", tagline: "text-fam-on-dark/70", socialBorder: "border-fam-card/20", socialHover: "hover:bg-fam-card/10", heading: "text-fam-on-dark font-sans-body uppercase tracking-wider", listText: "text-fam-on-dark/70", listHover: "hover:text-fam-on-dark", areaAll: "text-brand-200 hover:text-fam-on-dark", border: "border-fam-card/10", bottomText: "text-fam-on-dark/50", bottomHover: "hover:text-fam-on-dark", logoLight: true },
  bold: { surface: "bg-ink-900 text-fam-on-dark", tagline: "text-ink-100/70", socialBorder: "border-fam-card/20", socialHover: "hover:bg-fam-card/10", heading: "text-fam-on-dark font-display uppercase tracking-wider", listText: "text-ink-100/70", listHover: "hover:text-fam-on-dark", areaAll: "text-fam-accent-text hover:text-fam-on-dark", border: "border-fam-card/10", bottomText: "text-ink-100/50", bottomHover: "hover:text-fam-on-dark", logoLight: true },
  elegant: { surface: "bg-fam-surface text-fam-ink", tagline: "text-fam-ink-muted", socialBorder: "border-fam-hairline", socialHover: "hover:bg-fam-accent-soft", heading: "text-fam-ink font-display tracking-wide", listText: "text-fam-ink-muted", listHover: "hover:text-fam-accent-text-strong", areaAll: "text-fam-accent-text-strong hover:text-fam-accent-text", border: "border-fam-hairline", bottomText: "text-fam-ink-muted", bottomHover: "hover:text-fam-accent-text-strong", logoLight: false },
  friendly: { surface: "bg-fam-surface-2 text-fam-ink", tagline: "text-fam-ink-muted", socialBorder: "border-fam-hairline", socialHover: "hover:bg-fam-accent-soft", heading: "text-fam-ink font-display tracking-tight", listText: "text-fam-ink-muted", listHover: "hover:text-fam-accent-text-strong", areaAll: "text-fam-accent-text-strong hover:text-fam-accent-text", border: "border-fam-hairline", bottomText: "text-fam-ink-muted", bottomHover: "hover:text-fam-accent-text-strong", logoLight: false },
  corporate: { surface: "bg-fam-statement text-fam-on-dark", tagline: "text-fam-on-dark/60", socialBorder: "border-fam-card/15", socialHover: "hover:bg-fam-card/10", heading: "text-fam-on-dark font-display uppercase tracking-wide", listText: "text-fam-on-dark/60", listHover: "hover:text-fam-on-dark", areaAll: "text-fam-accent-on-dark hover:text-fam-on-dark", border: "border-fam-card/10", bottomText: "text-fam-on-dark/40", bottomHover: "hover:text-fam-on-dark", logoLight: true },
  creative: { surface: "bg-fam-ink text-fam-on-dark", tagline: "text-fam-on-dark/60", socialBorder: "border-fam-card/15", socialHover: "hover:bg-fam-accent", heading: "text-fam-on-dark font-display tracking-tight", listText: "text-fam-on-dark/60", listHover: "hover:text-fam-on-dark", areaAll: "text-fam-accent-on-dark hover:text-fam-on-dark", border: "border-fam-card/10", bottomText: "text-fam-on-dark/40", bottomHover: "hover:text-fam-on-dark", logoLight: true },
  modern: { surface: "bg-fam-ink text-fam-on-dark", tagline: "text-fam-on-dark/60", socialBorder: "border-fam-card/15", socialHover: "hover:bg-fam-card/10", heading: "text-fam-on-dark font-display tracking-tight", listText: "text-fam-on-dark/60", listHover: "hover:text-fam-on-dark", areaAll: "text-fam-accent-on-dark hover:text-fam-on-dark", border: "border-fam-card/10", bottomText: "text-fam-on-dark/40", bottomHover: "hover:text-fam-on-dark", logoLight: true },
    ...
    <>
      <div className="container-x pt-16">
        <div className={`flex flex-col items-start justify-between gap-6 ${rounded ? 'rounded-3xl' : 'rounded-xl'} border ${t.border} px-8 py-10 sm:flex-row sm:items-center`}>
          ...
          {HAS_PHONE && (<a href={`tel:${SITE.phone}`} className={`inline-flex h-12 items-center gap-2 ${rounded ? 'rounded-2xl' : 'rounded-lg'} bg-cta px-7 font-display text-sm font-semibold text-cta-foreground shadow-lg transition-transform hover:-translate-y-0.5`}>
