        ...
        <div className="flex flex-wrap gap-2">
          {areas.map((a) => (
            <Link
              ...
              to="/areas/$slug"
              params={{ slug: a.slug }}
              className="inline-flex items-center gap-1.5 rounded-md border border-ink-100 px-3 py-2 text-sm text-ink-700 transition-colors hover:border-fam-accent hover:text-fam-accent-text-strong"
            >
