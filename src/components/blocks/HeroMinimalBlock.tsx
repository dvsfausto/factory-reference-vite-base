      ...
      <div className="container-x py-section">
        ...
        >
          ...
          <div className="mt-12 flex flex-wrap items-center gap-4">
            <PrimaryCta
              className="inline-flex h-[56px] items-center gap-2 rounded-xl bg-cta px-8 font-display text-base font-semibold text-cta-foreground transition-[filter] hover:brightness-(--hov-shade)"
            >
