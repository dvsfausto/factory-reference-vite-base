        ...
        <div className="overflow-hidden rounded-3xl border border-fam-hairline bg-fam-card p-8 md:p-12">
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <Link to="/contact" className="mt-7 inline-flex h-12 items-center rounded-xl bg-cta px-7 font-display text-sm font-semibold text-cta-foreground transition-opacity hover:opacity-(--hov-fade)">Check your options</Link>
            </div>
