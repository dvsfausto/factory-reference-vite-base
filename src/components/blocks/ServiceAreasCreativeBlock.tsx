        ...
        <div className="flex flex-wrap gap-3">
          {areas.map((a) => (
            <Link
              ...
              to="/areas/$slug"
              params={{ slug: a.slug }}
              className="inline-flex items-center gap-2 rounded-full border-2 border-fam-accent px-5 py-2.5 font-display text-sm font-bold text-fam-accent-text-strong transition-colors hover:bg-fam-accent hover:text-white"
            >
              {a.name}
            </Link>
          ))}
