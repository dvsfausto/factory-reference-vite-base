    ...
    <section className="bg-fam-surface-2">
      <div className="container-x py-section">
        ...
        <div className="mt-10">
          <Link
            to="/areas"
            className="inline-flex h-14 items-center gap-2 rounded-2xl bg-cta px-7 font-display text-base font-bold text-cta-foreground transition-transform hover:translate-y-(--hov-lift-sm)"
          >
