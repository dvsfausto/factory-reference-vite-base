...
export function SubmitButton({
  ...
  return (
    <button
      ...
      className="inline-flex h-12 items-center justify-center rounded-xl bg-cta px-7 font-display text-sm font-semibold text-cta-foreground transition-opacity hover:opacity-90 disabled:opacity-60"
    >
