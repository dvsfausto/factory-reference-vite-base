  ...
  return (
    <section className="bg-fam-card">
      <div className="container-x py-section">
        ...
        <div className="mt-10">
          <Link to="/contact" className="inline-flex h-12 items-center rounded-xl bg-cta px-7 font-display text-sm font-semibold text-cta-foreground transition-opacity hover:opacity-(--hov-fade)">Apply for financing</Link>
        </div>
      </div>
    </section>
  )
