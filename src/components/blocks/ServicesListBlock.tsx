    ...
    <section className="bg-white">
      <div className="container-x py-section">
        ...
        <div className="mt-12 border-t border-fam-hairline">
          {rows.map((s, i) => (
            ...
            >
              ...
              <h3 className="font-display text-2xl font-semibold tracking-tight text-fam-ink transition-colors group-hover:text-fam-accent-text md:col-span-5 md:text-3xl">
                {s.displayName}
              </h3>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3">
          ...
          <span className="font-display text-sm font-medium text-fam-ink-muted">{exploreLabel}</span>
        </div>
      </div>
    </section>
  )
